Contributing to PROXYNODE Core
============================

The PROXYNODE Core project operates an open contributor model where anyone is
...
The following applies to code changes to the PROXYNODE Core project, and is not to be
confused with overall PROXYNODE Network Protocol consensus changes.

Whether a pull request is merged into PROXYNODE Core rests with the project merge
...
Patches that change PROXYNODE consensus rules are considerably more involved than
...
Where a patch set proposes to change the PROXYNODE consensus, it must have been
...
The project leader is the release manager for each PROXYNODE Core release.
