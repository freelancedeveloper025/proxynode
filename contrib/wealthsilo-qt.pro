...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/proxynode-cli.cpp \
           src/proxynode-tx.cpp \
           src/proxynode.cpp \
           src/db.cpp \
           ...
           src/qt/proxynode.cpp \
           src/qt/proxynodestrings.cpp \
...
RESOURCES += src/qt/proxynode.qrc src/qt/proxynode_locale.qrc

TRANSLATIONS += src/qt/locale/proxynode_bg.ts \
                src/qt/locale/proxynode_de.ts \
                src/qt/locale/proxynode_en.ts \
                src/qt/locale/proxynode_es.ts \
                src/qt/locale/proxynode_fi.ts \
                src/qt/locale/proxynode_fr.ts \
                src/qt/locale/proxynode_it.ts \
                src/qt/locale/proxynode_ja.ts \
                src/qt/locale/proxynode_pl.ts \
                src/qt/locale/proxynode_pt.ts \
                src/qt/locale/proxynode_ru.ts \
                src/qt/locale/proxynode_sk.ts \
                src/qt/locale/proxynode_sv.ts \
                src/qt/locale/proxynode_vi.ts \
                src/qt/locale/proxynode_zh_CN.ts \
                src/qt/locale/proxynode_zh_TW.ts
