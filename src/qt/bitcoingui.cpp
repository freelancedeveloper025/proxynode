                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("PROXYNODE Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PROXYNODE address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and proxynode: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zPRX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About PROXYNODE Core"), this);
    aboutAction->setStatusTip(tr("Show information about PROXYNODE Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PROXYNODE"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PROXYNODE addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PROXYNODE addresses"));
    ...
    openAction->setStatusTip(tr("Open a PROXYNODE: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the PROXYNODE Core help message to get a list with possible PROXYNODE command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("PROXYNODE Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PROXYNODE network", "", count));
}
...
{
    QString strTitle = tr("PROXYNODE Core"); // default title
...
/** Creates context menu, its actions, and proxynodes up all the relevant signals for mouse events. */
