...
/** Utility functions used by the PROXYNODE Qt UI.
 */
namespace GUIUtil
{
...
// Render PROXYNODE addresses in monospace font
...
// Parse "proxynode:" URI into recipient object, return true on successful parsing
