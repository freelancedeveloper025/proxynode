...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"proxynode", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"proxynode", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use proxynoded, or the -server option to proxynode-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
