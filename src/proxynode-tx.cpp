...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("PROXYNODE Core proxynode-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  proxynode-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded proxynode transaction") + "\n" +
                               "  proxynode-tx [options] -create [commands]   " + _("Create hex-encoded proxynode transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded proxynode transaction
